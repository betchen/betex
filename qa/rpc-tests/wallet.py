...
#   c) node1 mines 32 blocks, so now node 0 has 60001betex, node 1 has 4250betex, node2 has none.
#   d) node0 sends 601 betex to node2, in two transactions (301 betex, then 300 betex).
