...
RESOURCES += src/qt/betex.qrc src/qt/betex_locale.qrc

TRANSLATIONS += src/qt/locale/betex_bg.ts \
                src/qt/locale/betex_de.ts \
                src/qt/locale/betex_en.ts \
                src/qt/locale/betex_es.ts \
                src/qt/locale/betex_fi.ts \
                src/qt/locale/betex_fr.ts \
                src/qt/locale/betex_it.ts \
                src/qt/locale/betex_ja.ts \
                src/qt/locale/betex_pl.ts \
                src/qt/locale/betex_pt.ts \
                src/qt/locale/betex_ru.ts \
                src/qt/locale/betex_sk.ts \
                src/qt/locale/betex_sv.ts \
                src/qt/locale/betex_vi.ts \
                src/qt/locale/betex_zh_CN.ts \
                src/qt/locale/betex_zh_TW.ts
