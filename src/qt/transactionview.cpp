                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received Betex from zBetex"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zBetex"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zBetex));
