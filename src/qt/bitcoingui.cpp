                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("BETEX Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a BETEX address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and betex: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zBETEX"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About BETEX Core"), this);
    aboutAction->setStatusTip(tr("Show information about BETEX Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for BETEX"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your BETEX addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified BETEX addresses"));
    ...
    openAction->setStatusTip(tr("Open a BETEX: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the BETEX Core help message to get a list with possible BETEX command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("BETEX Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to BETEX network", "", count));
}
...
{
    QString strTitle = tr("BETEX Core"); // default title
