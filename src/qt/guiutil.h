...
/** Utility functions used by the BETEX Qt UI.
 */
namespace GUIUtil
{
...
// Render BETEX addresses in monospace font
...
// Parse "betex:" URI into recipient object, return true on successful parsing
