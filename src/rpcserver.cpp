...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Betex features */
        {"betex", "masternode", &masternode, true, true, false},
        {"betex", "listmasternodes", &listmasternodes, true, true, false},
        {"betex", "getmasternodecount", &getmasternodecount, true, true, false},
        {"betex", "masternodeconnect", &masternodeconnect, true, true, false},
        {"betex", "masternodecurrent", &masternodecurrent, true, true, false},
        {"betex", "masternodedebug", &masternodedebug, true, true, false},
        {"betex", "startmasternode", &startmasternode, true, true, false},
        {"betex", "createmasternodekey", &createmasternodekey, true, true, false},
        {"betex", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"betex", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"betex", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"betex", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"betex", "getmasternodescores", &getmasternodescores, true, true, false},
        {"betex", "mnbudget", &mnbudget, true, true, false},
        {"betex", "preparebudget", &preparebudget, true, true, false},
        {"betex", "submitbudget", &submitbudget, true, true, false},
        {"betex", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"betex", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"betex", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"betex", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"betex", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"betex", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"betex", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"betex", "checkbudgets", &checkbudgets, true, true, false},
        {"betex", "mnsync", &mnsync, true, true, false},
        {"betex", "spork", &spork, true, true, false},
        {"betex", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"betex", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use betexd, or the -server option to betex-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> betex-cli " + methodname + " " + args + "\n";
}
