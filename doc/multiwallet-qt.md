...
In order to support loading of multiple wallets in betex-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is betex.cpp.
...
Changes to betex.cpp
----------------------
betex.cpp is the entry point into betex-qt, and as such, will require some minor modifications to provide hooks for
