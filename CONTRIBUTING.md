Contributing to BETEX Core
============================

The BETEX Core project operates an open contributor model where anyone is
...
The following applies to code changes to the BETEX Core project, and is not to be
confused with overall BETEX Network Protocol consensus changes.

Whether a pull request is merged into BETEX Core rests with the project merge
...
Patches that change BETEX consensus rules are considerably more involved than
...
Where a patch set proposes to change the BETEX consensus, it must have been
...
The project leader is the release manager for each BETEX Core release.
